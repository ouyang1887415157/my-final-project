...
You can open it with Unity Hub with any Unity Version that is compatible with Unity 6000.0.26f1. If you cannot download it using git clone, try to download zip file. If you find there is no game in the file, find the game in the scenes folder.
